In this independent project, I conceptualized and developed a sophisticated React-based Single Page Application (SPA) specifically tailored to assist producers and DJs in curating captivating setlists for their live performances.

When the user navigates to the page, they are greeted with a sleek login page that displays the title of the application as well as interactable links to my social media accounts.
...
<img width="1434" alt="Screen Shot 2023-05-17 at 2 43 12 PM" src="https://github.com/JaredFunaro/PlaylistsForProducers/assets/117308724/621a1603-39f0-4ab2-aa38-453de5d64a22">
